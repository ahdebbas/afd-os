...
function Shell() {
  ...
  return (
    <div className="h-dvh w-full max-w-md mx-auto relative flex flex-col">
      ...
      {/* Dock + FAB */}
      <nav className={`fixed bottom-5 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 transition-opacity ${kbOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`} aria-label="Modules">
